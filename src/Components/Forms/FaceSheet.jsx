            ...
            <div className="formheading1">
                ...
                <form action="">
                    <div className="form-section">
                        ...
                        <div className="form-field">
                            <label htmlFor="AHCCCS">Family/Guardian Emergency Name and Contact:</label>
                            <input
                                type="text"
                                id="AHCCCS"
                                value=''
                        ...
                        <div className="form-field">
                            <label htmlFor="AHCCCS">Other Allergies (animal, food, environment)</label>
                            <input
                                type="text"
                                id="AHCCCS"
                                value=''
                        ...
                        <div className="form-field">
                            <label htmlFor="AHCCCS">Social Security Representative Payee:</label>
                            <input
                                type="text"
                                id="AHCCCS"
                                value=''
