    ...
    return (
        <>
            ...
            <div className="form-container">
                <FormUpper />
                <p>COMPANY NAME has notified __________________________________________________ to participate
                    in his/her Service Treatment Plan/Initial Assessment on __________________</p>
                <form>
                    <h5>Section - 1</h5>
                    <div className="form-section">
                        ...
                        <div className="form-field">
                            <label htmlFor="programlocation&address" style={{ display: 'flex', justifyContent: 'space-between' }}>Program Location & Address  <img src={locate} alt="" style={{ width: '92px', height: "29px" }} /></label>
                            <textarea
                        ...
                        <h2>Other Details</h2>
                        <div className="form-field">
                            <label htmlFor="reasonadmission">Reason for Admission to Services</label>
                            <select
                                id="reasonadmission"
                                value=''
                                required
                            >
                                ...
                                <option value="Enter text">Trouble falling or staying asleep</option>
                                ...
                                <option value="Enter text">Inability to maintain self care</option>
                                ...
                                <option value="Enter text">Inappropriate Sexual Behavior</option>
                        ...
                        <div className="form-field">
                            <label htmlFor="programlocation&address">Resident’s Limitation(s)</label>
                            <textarea
                                id="programlocation&address"
                                value=''
                                placeholder='Enter text'
                        ...
                        <div className="form-field">
                            <label htmlFor="programlocation&address">Current Behavioural Issues / Symptoms</label>
                            <textarea
                                id="programlocation&address"
                                value=''
                                placeholder='Enter text'
                        ...
                        <label htmlFor="programlocation&address">Identified Needs/targeted Behaviors Intervention(s) to Meet Objectives</label>
                        ...
                        <div class="checkbox-container1">
                            <div class='checkoptions1'>
                                <div class='checkboxitem1'>
                                    <input type="checkbox" />
                                    <span> Yes, I (Resident/guardian) am in agreement with the types and levels of services included in my behavior plan.</span>
                                </div>
                                <div class='checkboxitem1'>
                                    <input type="checkbox" />
                                    <span>No, I (Resident/guardian) disagree with the types and/or levels of some or all of the services included in my behavioral health treatment plan. By checking this box, I (Resident/guardian) will receive the services that I have agreed to receive and may appeal the treatment team’s decision to not include all the types and/ or levels of services that I have requested. *</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="file-upload-box">
                            <input type="file" id="fileInput" style={{ display: 'none' }} />
                            <div class="upload-icon">
                                <img src={formupload} alt="" style={{ width: "74px", height: "74px" }} />
                            </div>
                            <div style={{ display: 'block' }}>
                                <button className='upload-button1' onclick="uploadFile()">SAVED AS DRAFT</button>
                                <button className="upload-button" onclick="uploadFile()">SAVED AND SIGNED</button>
                        ...
                        <div className='formsheading'>
                            <p>A. Currently prescribed medications are attached on a separate page.</p>
                        ...
                        <div className='yeschechbox'>
                            <label htmlFor="">Lung disease (ie asthma, COPD, emphysema)</label>
                            <div>
                                <input type="checkbox" name="" id="" />
                                <span>Yes</span>
                            </div>
                        ...
                        <div className='yeschechbox'>
                            <label htmlFor="">Allergies (food, environment, medications)</label>
                            <div>
                                <input type="checkbox" name="" id="" />
                                <span>Yes</span>
                            </div>
                        ...
                        <div className="form-field">
                            <label htmlFor="reasonadmission">Significant Family Medical/Psychiatric History:</label>
                            <select
                                id="reasonadmission"
                                value=''
                                required
                        ...
                        <div className='formsheading'>
                            <h6>Mental Health Treatment History (in Resident hospitalization, partial hospitalization, out Resident, etc):</h6>
                        </div>
                        <div className="form-field">
                        ...
                        <div className="form-field">
                            <label htmlFor="reasonadmission">Diagnosis/Reason for Treatment</label>
                            <select
                                id="reasonadmission"
                                value=''
                                required
                            >
                                ...
                                <option value="Enter text">DTS/DTO Other (Please specify)</option>
                        ...
                        <div className="form-field">
                            ...
                            >
                                ...
                                <option value="Enter text">Hallucinogens (LSD,mescaline,etc.)</option>
                        ...
                        <div className="form-field">
                            <label htmlFor="approvedby">Significant Social/Developmental History:</label>
                            <input
                                type='text'
                                id="approvedby"
                                value=''
                        ...
                        <div className="form-field">
                            <label htmlFor="programlocation&address">Work History (and barriers to employment)</label>
                            <textarea
                                id="programlocation&address"
                                value=''
                                placeholder='Enter text'
                        ...
                        <div className="form-field">
                            <label htmlFor="reasonadmission">Criminal Justice Legal History</label>
                            <select
                                id="reasonadmission"
                                value=''
                                required
                            >
                                ...
                                <option value="Enter text">Arrested for attempted murder</option>
                                <option value="Enter text">Arrested for drug</option>
                                <option value="Enter text">Arrested for alcohol</option>
                                <option value="Enter text">Arrested for disorderly conduct</option>
                                <option value="Enter text">Arrested for identity theft/ forgery</option>
                        ...
                        <div className="form-field">
                            <label htmlFor="programlocation&address">Hobbies/Leisure Activities:</label>
                            <textarea
                                id="programlocation&address"
                                value=''
                                placeholder='Enter text'
                        ...
                        <div className="form-field">
                            ...
                            >
                                ...
                                <option value="Enter text">Inappropriate Sexual Behaviors</option>
                                <option value="Enter text">Substance use</option>
                        ...
                        <div className='yeschechbox1'>
                            <label htmlFor="">Are you currently thinking about harming yourself or committing suicide?</label>
                            <div>
                                <input type="checkbox" name="" id="" />
                                <span>Yes</span>
                            </div>
                        ...
                        <div className='yeschechbox1'>
                            <label htmlFor="">Are you currently thinking about harming others or have homicidal thoughts?</label>
                            <div>
                                <input type="checkbox" name="" id="" />
                                <span>Yes</span>
                            </div>
                        ...
                        <div className="form-field">
                            <label htmlFor="reasonadmission">Select risk factors that apply</label>
                            <select
                                id="reasonadmission"
                                value=''
                                required
                            >
                                ...
                                <option value="Enter text">Access to means (i.e. weapon)</option>
                                <option value="Enter text">Substance abuse</option>
                                <option value="Enter text">Other self-abusing behavior</option>
                                <option value="Enter text">Recent losses/lack of support</option>
                        ...
                        <div className="form-field">
                            <label htmlFor="reasonadmission">Protective factors that apply:</label>
                            <select
                                id="reasonadmission"
                                value=''
                                required
                            >
                                <option value="Enter text">Enter text</option>
                                <option value="Enter text">Supports available (family friends)</option>
                                <option value="Enter text">Spiritual / religious support</option>
                                <option value="Enter text">Religious/cultural prohibitions</option>
                                <option value="Enter text">Fear of consequences</option>
                                <option value="Enter text">Able to be engaged in intervention</option>
                                <option value="Enter text">Willing to commit to keeping self safe</option>
                                {/* <option value="Female">Sanskrit</option> */}
                            </select>
                        </div>
                        <div className='yeschechbox'>
                        ...
                        <div className='formsheading'>
                            <p>Considering the responses to the above risk factors in combination with all the other information you know about the person (gender, age, diagnosis, balancing factors-resiliency and supports, would you rate the level of risk for this person for danger to self (DTS) as:</p>
                        </div>
                        <div className='yeschechbox1'>
                            <div>
                                <input type="checkbox" name="" id="" />
