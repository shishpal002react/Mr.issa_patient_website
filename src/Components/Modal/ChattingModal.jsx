  ...
  return (
    <div className="chattingmodal-overlay" onClick={onClose}>
      ...
      <IoArrowBackCircle
        ...
        />  
        {
          !user? ( <button type="button" style={{border:"none",outline:"none",padding:"5px" ,borderRadius:"5px",width:"5rem",backgroundColor:"lightblue"}} onClick={googleSignIn}>Login</button>): 
          <button type="button" style={{border:"none",outline:"none",padding:"5px" ,borderRadius:"5px",width:"5rem",backgroundColor:"lightblue"}} onClick={handleSignOut}>Logout</button>
        }
