    ...
    <>
      <div className="navbar1">
        <div className="left-section">
          <span><MdOutlineSegment onClick={toggleMenu} /></span>
          <span>Welcome,</span>
          <h6>Jacob</h6>
          <img src={sun} alt="" />
        </div>
        ...
        <ProfileModal onClose={closeProfileModal}>
          <div className="profilemodal-container">
            <div className="profilemodal-header">
              <img src={profilemodal} alt="Profile" className="profilemodal-image" />
              <h2>Jacob Smith</h2>
              <p><span>STATUS:</span> ADMITTED AT CENTRE 1</p>
              <button className='profilemodalbutton'>SIGN OUT</button>
            </div>
            <div className="personalmodal-info">
              <p> <IoDocumentTextOutline />Intake Documents <MdErrorOutline /></p>
              <p> <PiCalendarCheckLight /> Medical Appointment</p>
              <p> <MdOutlineNoteAlt /> Staffing Note/ Concurrent Review</p>
              <p> <PiCalendarCheckLight /> Medication Script Upload</p>
      ...
      {isNotificationModalOpen && (
        <NotificationModal onClose={closeNotificationModal}>
          <div className='notification'>
            ...
            <p style={{ color: '#1E1E1E99', fontWeight: '700', fontSize: "14px", marginTop: "20px" }}>TAP TO VIEW</p>
          </div>
        </NotificationModal>
      )}
